      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-end">
          ...
          <button
            ...
            className=
            "bg-cyan-500 disabled:bg-gray-300 disabled:cursor-not-allowed text-slate-900 font-bold py-2 px-5 rounded-lg transition-colors duration-300 hover:bg-cyan-400"
          >
            Bid now
          </button>
        </div>
