export const ResponseMessages = {
  ...
  SELLER_SIGNUP_PENDING:
    "Signup successful. Your account requires admin approval before you can access seller features.",
  APPLICATION_SUBMITTED: "Application submitted",
  OTP_SEND_SUCCESS: "OTP send successfully",
  OTP_VERIFY_SUCCES: "OTP verified successfully",
  EMAIL_LINK_SEND: "link sent to emal",
  ...
  PLAN_RENEWAL_TOO_EARLY:
    "Renewal is only allowed within the last 5 days of your current subscription.",
  PLAN_RENEWAL_SUCCESS: "Your plan has been successfully renewed.",
  PLAN_RENEWAL_EXPIRED:
    "This subscription is expired and cannot be renewed. Please start a new subscription.",
  ...
  DUPLICATE_BID_COUNT: "Duplicate bid count.",
  AMOUNT_GREATER_THAN_PREVIOUS: "Amount must be greater than previous pack.",
  UNIT_PRICE_LOWER_THAN_PREVIOUS:
    "Unit price must be lower than previous pack.",
  AMOUNT_LOWER_THAN_NEXT: "Amount must be lower than next pack.",
  UNIT_PRICE_HIGHER_THAN_NEXT: "Unit price must be higher than next pack.",
};
