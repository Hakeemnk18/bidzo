import { ICategoryAllDoc, ICreateCategoryDTO, IGetAllCategoryDTO } from "../../dtos/category.dto";
import { Category } from "../../types/category.type";

export interface ICategoryService {
  getAllCategories(data: IGetAllCategoryDTO): Promise<{resData: Category[], total: number}>;
